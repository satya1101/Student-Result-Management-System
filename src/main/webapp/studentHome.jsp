...
<body>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>NAS102</td>
        <td colspan="2">Data structure & algorithm</td>
        <td>Theory</td>
        <td>100</td>
        <td>30</td>
      ...
      <tr>
        <td>NEC101</td>
        <td colspan="2">Cloud Computing</td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>NAS152</td>
        <td colspan="2">Cloud computing  Lab</td>
        <td>Practical</td>
        <td>30</td>
        <td>15</td>
      ...
      <tr>
        <td>NAS151</td>
        <td colspan="2">Data science Lab</td>
        <td>Practical</td>
        <td>30</td>
        <td>15</td>
...
Designed & Developed by DGI Team</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @DGI :: 2020-2023</h6></center> 
  <hr class="new1">
</body>
