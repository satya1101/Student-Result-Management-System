...
<!DOCTYPE html>
<html>
<title>Decan Gurukul Institute</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Advance Java</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Data structure & algorithm</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">cloud computing</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Cloud computing Lab</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Data science Lab</label>
                                    <div class="col-md-6">
...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact Satyagopal.
Designed & Developed by Satyagopal Bindhani </h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @DGI :: 2020-2023</h5></center> 
  <hr class="new1">
<br>
</body>
</html>